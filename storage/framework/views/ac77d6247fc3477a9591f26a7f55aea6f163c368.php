    ...
    <div class="container grid px-6 mx-auto">
        ...
        <div class="w-full overflow-hidden rounded-lg shadow-xs mt-2">
            <div class="w-full overflow-x-auto">
                <table class="w-full whitespace-no-wrap">
                    ...
                    <tbody class="bg-white divide-y dark:divide-gray-700 dark:bg-gray-800">
                        <?php $__currentLoopData = $player; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $playerr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr class="text-gray-700 dark:text-gray-400">
                                ...
                                <div class="flex items-center text-sm">
                                    ...
                                    <div>
                                        ...
                                        <span
                                            ...
                                            <?php if($playerr->Guild): ?>
                                            <?php echo e($playerr->Guild->name); ?>
                            ...
                            <td class="px-4 py-3 text-xs">
                                <span
                                    class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100">
                                    <a
                                        href="<?php echo e(route('account.show', $playerr->account->login)); ?>"><?php echo e($playerr->account->login); ?></a>
                                </span>
                            </td>
            ...
            <div class="my-4 flex justify-center flex-1 lg:mr-32">
                ...
                <?php echo e($player->withQueryString()->links()); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\PC\Desktop\dev\laravel-metin2-admin-panel\resources\views/player/list.blade.php ENDPATH**/ ?>