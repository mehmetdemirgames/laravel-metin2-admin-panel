                    ...
                    <div class="w-full">
                        ...
                        <form method="POST" action="<?php echo e(route('login')); ?>">
                            ...
                            <label class="block text-sm">
                                ...
                                <input class="block w-full mt-1 text-sm dark:border-gray-600 dark:bg-gray-700 focus:border-purple-400 focus:outline-none focus:shadow-outline-purple dark:text-gray-300 dark:focus:shadow-outline-gray form-input" placeholder="Jane Doe" name="email" value="<?php echo e(old('email')); ?>" required autofocus />
                            </label>
...
<?php endif; ?><?php /**PATH C:\Users\PC\Desktop\dev\laravel-metin2-admin-panel\resources\views/auth/login.blade.php ENDPATH**/ ?>